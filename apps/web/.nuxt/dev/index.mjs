...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getResponseStatusText } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/h3@1.15.11/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, join, dirname } from 'node:path';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/@vue+shared@3.5.40/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/@nuxt+vite-builder@4.5.0_8e2bdeac7cc05c1fad42760a10a66b1f/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/@nuxt+vite-builder@4.5.0_8e2bdeac7cc05c1fad42760a10a66b1f/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, encodePath, joinRelativeURL } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/ufo@1.6.4/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/node-mock-http@1.0.4/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/unstorage@1.17.5_db0@0.3.4_@electric-sql+pglite@0.3.8_drizzle-orm@0.45.2_@electric-sql+pglite@0.3.8___ioredis@5.11.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/unstorage@1.17.5_db0@0.3.4_@electric-sql+pglite@0.3.8_drizzle-orm@0.45.2_@electric-sql+pglite@0.3.8___ioredis@5.11.1/node_modules/unstorage/drivers/fs.mjs';
import { mkdir, writeFile, rename, unlink, readFile } from 'node:fs/promises';
import fsDriver from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/unstorage@1.17.5_db0@0.3.4_@electric-sql+pglite@0.3.8_drizzle-orm@0.45.2_@electric-sql+pglite@0.3.8___ioredis@5.11.1/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/unstorage@1.17.5_db0@0.3.4_@electric-sql+pglite@0.3.8_drizzle-orm@0.45.2_@electric-sql+pglite@0.3.8___ioredis@5.11.1/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest, hash as hash$1 } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/defu@6.1.7/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import consola, { consola as consola$1 } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/youch-core@0.3.3/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/youch@4.1.1/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/source-map.js';
import { defineDiagnostics, createConsoleReporter } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/nostics@1.2.0/node_modules/nostics/dist/index.mjs';
import { ansiFormatter } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/nostics@1.2.0/node_modules/nostics/dist/formatters/ansi.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/devalue@5.8.2/node_modules/devalue/index.js';
import { getContext as getContext$1 } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/unctx@3.0.0_magic-string@1.1.0_oxc-parser@0.140.0_rolldown@1.2.0_unplugin@3.3.0_esbuild_6d63d8f3e69229c9537247f37122f394/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/vue@3.5.40_typescript@5.9.3/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/@nuxt+vite-builder@4.5.0_8e2bdeac7cc05c1fad42760a10a66b1f/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/vue-bundle-renderer@2.3.1/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { renderToString } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/vue@3.5.40_typescript@5.9.3/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/unhead@3.2.3_esbuild@0.28.1_rolldown@1.2.0_rollup@4.62.2_vite@8.1.5_@types+node@24.13.3_0fe3e869fb6f24d95660b0a07497ea97/node_modules/unhead/dist/server.mjs';
import { walkResolver } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/unhead@3.2.3_esbuild@0.28.1_rolldown@1.2.0_rollup@4.62.2_vite@8.1.5_@types+node@24.13.3_0fe3e869fb6f24d95660b0a07497ea97/node_modules/unhead/dist/utils.mjs';
import { DeprecationsPlugin } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/unhead@3.2.3_esbuild@0.28.1_rolldown@1.2.0_rollup@4.62.2_vite@8.1.5_@types+node@24.13.3_0fe3e869fb6f24d95660b0a07497ea97/node_modules/unhead/dist/legacy.mjs';
import { PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/aice/Developer/hymui/node_modules/.pnpm/unhead@3.2.3_esbuild@0.28.1_rolldown@1.2.0_rollup@4.62.2_vite@8.1.5_@types+node@24.13.3_0fe3e869fb6f24d95660b0a07497ea97/node_modules/unhead/dist/plugins.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/aice/Developer/hymui/apps/web/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/aice/Developer/hymui/apps/web","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/aice/Developer/hymui/apps/web/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', cache_driver_default({"driver":"/Users/aice/Developer/hymui/node_modules/.pnpm/@nuxt+nitro-server@4.5.0_354b1de94c2e2e753562a0198fdc18ef/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.mjs","base":"/Users/aice/Developer/hymui/apps/web/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/aice/Developer/hymui/apps/web/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/aice/Developer/hymui/apps/web/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/aice/Developer/hymui/apps/web/.data/kv"}));
...
const rootDir = "/Users/aice/Developer/hymui/apps/web";
...
const _9Rr3SA = eventHandler((event) => {
...
const _lazy_TTzYec = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _9Rr3SA, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_TTzYec, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_TTzYec, lazy: true, middleware: false, method: undefined }
];
